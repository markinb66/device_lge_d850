...
/**
 * Custom Qualcomm RIL for D850
 *
 * {@hide}
 */
public class D850RIL extends RIL implements CommandsInterface {
    static final String LOG_TAG = "VS985RIL";

    public D850RIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public D850RIL(Context context, int preferredNetworkType,
